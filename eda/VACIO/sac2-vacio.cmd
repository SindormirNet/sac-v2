...
# Start of element VR2
ChangePinName(VR2, 3, 3)
ChangePinName(VR2, 2, 2)
ChangePinName(VR2, 1, 1)
...
# Start of element U4
ChangePinName(U4, 5, Vcc)
ChangePinName(U4, 1, TX)
ChangePinName(U4, 2, RX)
ChangePinName(U4, 4, GND)
ChangePinName(U4, 28, LED)
ChangePinName(U4, 26, GND)
ChangePinName(U4, 16, ANT2)
ChangePinName(U4, 15, ANT1)
ChangePinName(U4, 27, +5v)

# Start of element U3
ChangePinName(U3, unknown, unknown)
ChangePinName(U3, unknown, unknown)
ChangePinName(U3, 1, C1+)
ChangePinName(U3, 14, Tx1 Out)
ChangePinName(U3, 13, Rx1 In)
ChangePinName(U3, 12, Rx1 Out)
ChangePinName(U3, 11, Tx1 In)
ChangePinName(U3, 10, Tx2 In)
ChangePinName(U3, 9, Rx2 Out)
ChangePinName(U3, 8, Rx2 In)
ChangePinName(U3, 7, Tx2 Out)
ChangePinName(U3, 6, V-)
ChangePinName(U3, 5, C2-)
ChangePinName(U3, 4, C2+)
ChangePinName(U3, 3, C1-)
ChangePinName(U3, 2, V+)

# Start of element U2
ChangePinName(U2, 15, (OC1A/PCINT1) PB1)
ChangePinName(U2, 16, (SS/OC1B/PCINT2) PB2)
ChangePinName(U2, 17, (MOSI/OC2A/PCINT3) PB3)
ChangePinName(U2, 18, (MISO/PCINT4) PB4)
ChangePinName(U2, 19, (SCK/PCINT5) PB5)
ChangePinName(U2, 20, AVCC)
ChangePinName(U2, 21, AREF)
ChangePinName(U2, 22, GND)
ChangePinName(U2, 23, (ADC0/PCINT8) PC0)
ChangePinName(U2, 24, (ADC1/PCINT9) PC1)
ChangePinName(U2, 25, (ADC2/PCINT10) PC2)
ChangePinName(U2, 26, (ADC3/PCINT11) PC3)
ChangePinName(U2, 27, (ADC4/SDA/PCINT12) PC4)
ChangePinName(U2, 28, (ADC5/SCL/PCINT13) PC5)
ChangePinName(U2, 14, PB0 (PCINT0/CLKO/ICP1))
ChangePinName(U2, 13, PD7 (PCINT23/AIN1))
ChangePinName(U2, 12, PD6 (PCINT22/OC0A/AIN0))
ChangePinName(U2, 11, PD5 (PCINT21/OC0B/T1))
ChangePinName(U2, 10, PB7 (PCINT7/XTAL2/TOSC2))
ChangePinName(U2, 9, PB6 (PCINT6/XTAL1/TOSC1))
ChangePinName(U2, 8, GND)
ChangePinName(U2, 7, VCC)
ChangePinName(U2, 6, PD4 (PCINT20/XCK/T0))
ChangePinName(U2, 5, PD3 (PCINT19/OC2B/INT1))
ChangePinName(U2, 4, PD2 (PCINT18/INT0))
ChangePinName(U2, 3, PD1 (PCINT17/TXD))
ChangePinName(U2, 2, PD0 (PCINT16/RXD))
ChangePinName(U2, 1, PC6 (PCINT14/RESET))

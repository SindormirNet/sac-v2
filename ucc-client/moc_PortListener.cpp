...
**
** Created: Thu Jul 29 08:02:28 2010
...
static const char qt_meta_stringdata_PortListener[] = {
    "PortListener\0\0string\0newString(QString)\0"
    "receive()\0close_port()\0portportname\0"
    "open_port(QString)\0in\0write_port(QString)\0"
};
...
int PortListener::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: newString((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: receive(); break;
        case 2: close_port(); break;
        case 3: open_port((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 4: write_port((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 5;
    }
...
// SIGNAL 0
void PortListener::newString(QString _t1)
{
